...
public class ModifyPartController implements Initializable, ControllerInterface {
    
    // Declare field
    private static final int PARTINDEX= getModifyPartIndex();
    ...
    void handleModifyPartSave(ActionEvent event) throws IOException {
        ...
        try {
            String errorMessage = PartValidator.validate(
                    name,
